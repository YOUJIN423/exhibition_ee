...
<head>
<meta charset="UTF-8">
<title>ee Museum of Art_main_pwd_find</title>

<%--[외부 파일] --%>
<link rel="stylesheet"
	href="<%=request.getContextPath() %>/css/Member/member_deco_pwd_find.css">	
		  ...
		  <h2 class="pwd_title">비밀 번호 찾기</h2>
		 	 <form method="post" action="member_pwd_find_ok.do" onsubmit="return check()">  
		    	...
		    	<div class="id_find_part">
		     		<dt>아이디</dt>
		    	    <dd><input type="text" name="mem_id" id="id" size="14" class="input_box" /></dd>
		   	    </div>
			    <div class="name_find_part">
				     <dt>회원 이름</dt>
				     <dd><input type="text" name="mem_name" id="name" size="14" class="input_box" /></dd>
			    </div>
		   		</table>
