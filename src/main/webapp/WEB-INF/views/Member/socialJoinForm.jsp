...
<script src="<%=request.getContextPath() %>/js/Member/social.js"></script>
...
<body>
	...
	<main>
		<div class="joinform_wrap">
			...
			<div>
				<form name="member_join_F" method="post" action="<%=request.getContextPath()%>/socialJoin.do"
					...
					<li class="arc">
						<dt>이메일</dt>
						<dd>
							<input type="text" class="email_area" name="mem_email" id="mem_email" size="10" value="${email}" readonly/>   @   <input type="text"
								name="mem_domain" class="domain_area" id="mem_domain" size="20" value="${domain}" readonly /> 
						</dd>
					</li>
