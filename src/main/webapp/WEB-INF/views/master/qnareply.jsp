	...
	<main>
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-12">
					<form action="<%=request.getContextPath()%>/master/reply.do" method="post">
						<input type="hidden" name="page" value="${page}"> 
						<input type="hidden"  name="qna_num"  value="${qna_num}">
						<input type="hidden"  name="qna_title"  value="문의 답변입니다.">
						<table class="table table-hover">
							<tr>
								<th>답변</th>
								<td>
									<textarea name="qna_content" id="board_content" rows="10" cols="80" class="input_box p-1"></textarea>
								</td>
							</tr>
						</table>
