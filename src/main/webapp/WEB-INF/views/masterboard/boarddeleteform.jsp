...
<%--[외부 파일] --%>
<link rel="stylesheet" href="<%=request.getContextPath()%>/css/master/board.css">
</head>
...
<body>
	...
	<main>
		<form method=post action="<%=request.getContextPath()%>/master/boarddelete.do">
			<input type="hidden" name="board_num" value="${board.board_num }">
			<input type="hidden" name="page" value="${page}">
	
			<div class="div">
				<div class="div_h4"></div>
					<h3 class="h3">글 삭제</h3>
				</div>
				<p class ="board_title">${board.board_title}</p>
				<p class="text">해당 글을 삭제하시겠습니까?</p>
			</div>
