...
<body>
	...
	<main>
		<h3 style="margin-bottom: 70px;"><strong>현재 프로그램</strong></h3>
		<div align="left">
			<h4 style="margin-bottom: 50px;"><strong>[리움 들어서기] 2022 리움 들어서기: 고미술 손끝에서 시작된 마감</strong></h4>

			<img src="<%=request.getContextPath()%>/images/main_program_2.jpg" width="650" height="300" style="margin-bottom: 50px"><br>
		...
		<h3 style="margin-bottom:50px;"><strong>안내</strong></h3>
		<div>
