...
$(document).ready(function(){
	$("#confirm_btn").click(function(){
		if($("#mem_passwd").val()=='') {
			...
			$.ajax({
				type : "POST",
				url : "<%=request.getContextPath()%>/mypage/pwdConfirm.do",
				data : {
					"mem_passwd":$("#mem_passwd").val()
				},
				success:function(data){
					if($.trim(data)=='YES') {
						location.href="<%=request.getContextPath()%>/mypage/updateForm.do";
...
<body>
	...
	<main>
		<div class="container-fluid mt-2" style="margin-bottom: 110px;">
			<div class="row justify-content-center align-items-center"
					style="margin-top: 150px">
				<div class="col-5 border border-5 border-dark pt-5"
					style="height: 300px">
					<div class="row justify-content-center align-items-center"
						style="height: 150px">
						<div class="pt-2">
						...
						<div class="col-10 p-0">
							<form>
								...
								<div class="d-flex">
									...
									<input type="button" class="btn btn-dark ms-2" id="confirm_btn" value="확인">
								</div>
							</form>
						</div>
					</div>
